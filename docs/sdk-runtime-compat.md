...
| **Node.js** | 24.x | ✅ | ✅ | ✅ | ✅ | release-publish.yml runs npm publish jobs on 24 (npm 11+ for OIDC trusted publishing). |
...
- `.github/workflows/release.yml` builds and stages the release; `.github/workflows/release-publish.yml` publishes npm packages from the staged Release assets in dependency order. The build workflow also drives the CLI binary release, Docker, and Homebrew bump.
