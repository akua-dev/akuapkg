...
```
{"level":"error","code":"E_SCHEMA_INVALID","path":"apps/api/inputs.yaml","field":"replicas","message":"expected integer, got string","suggestion":"remove quotes around 3","docs":"https://cli.akua.dev/errors/E_SCHEMA_INVALID"}
```
