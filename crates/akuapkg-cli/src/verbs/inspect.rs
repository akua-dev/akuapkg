//! `akuapkg inspect` — report a Package's input surface OR a packed
...
//!   file count, and vendored deps. Pair with `akuapkg pack` +
//!   `akuapkg push` — operators triage an air-gap-transferred tarball
//!   before pushing it.
