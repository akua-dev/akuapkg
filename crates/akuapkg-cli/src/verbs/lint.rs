//! `akuapkg lint` — KCL parse-only validation of a Package.k.
//!
//! Spec: [`docs/cli.md`](../../../../docs/cli.md) `akuapkg lint` section.
//!
...
//! unresolved options) surface through `akuapkg render --dry-run`.
