//! `akuapkg init` — scaffold a new Package.
//!
//! Spec: [`docs/cli.md`](../../../../docs/cli.md) `akuapkg init` section.
        ...
        match self {
            ...
            InitError::EmptyName => {
                StructuredError::new(codes::E_INIT_EMPTY_NAME, self.to_string())
                    .with_suggestion("pass `akuapkg init <name>` or run from a named directory")
                    .with_default_docs()
            }
...
mod tests {
    ...
    fn scaffolded_akua_toml_and_package_k_round_trip_through_parsers() {
        ...
        // Render through the wasmtime sandbox — same path `akuapkg render`
