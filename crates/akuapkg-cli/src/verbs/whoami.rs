//! `akuapkg whoami` — identity + agent context introspection.
//!
//! Spec: [`docs/cli.md`](../../../../docs/cli.md) `akuapkg whoami` section;
...
fn write_text<W: Write>(stdout: &mut W, output: &WhoamiOutput) -> std::io::Result<()> {
    ...
    writeln!(stdout, "akuapkg version: {}", output.version)?;
...
mod tests {
    ...
    fn text_output_in_human_shell_is_compact() {
        ...
        assert!(out.contains("akuapkg version:"));
