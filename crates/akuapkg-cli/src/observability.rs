...
//! 4. Default: `warn,akua=info,akuapkg_cli=info,akua_core=info,akua_render_worker=info`
//!
...
fn resolve_filter_with(args: &UniversalArgs, rust_log: Option<&str>) -> String {
    ...
    format!("warn,akua={level},akuapkg_cli={level},akua_core={level},akua_render_worker={level}")
}
...
mod tests {
    ...
    fn resolve_filter_log_level_arg_drives_akua_targets() {
        ...
        assert!(f.contains("akuapkg_cli=trace"));
