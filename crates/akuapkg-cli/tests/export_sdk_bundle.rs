...
//!
//! Lives in `akuapkg-cli` (not `akua-core`) because the bundle needs to
//! register types from both crates — akuapkg-cli depends on akua-core,
...
//!
//! Trigger: `cargo test -p akuapkg-cli --features schema-export --test export_sdk_bundle`.
...
use akuapkg_cli::verbs::check::CheckOutput;
use akuapkg_cli::verbs::fmt::FmtOutput;
use akuapkg_cli::verbs::inspect::InspectOutput;
use akuapkg_cli::verbs::lint::LintOutput;
use akuapkg_cli::verbs::tree::TreeOutput;
use akuapkg_cli::verbs::verify::VerifyOutput;
use akuapkg_cli::verbs::version::VersionOutput;
use akuapkg_cli::verbs::whoami::WhoamiOutput;
